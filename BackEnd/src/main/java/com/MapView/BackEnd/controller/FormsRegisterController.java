...
public class FormsRegisterController {
    ...
    @PutMapping
    @Transactional
    public  ResponseEntity<RegisterDetailsDTO> updateregister(@RequestBody @Valid RegisterUpdateDTO data,@RequestParam Long userlog_id,@RequestParam String id_equipent){
