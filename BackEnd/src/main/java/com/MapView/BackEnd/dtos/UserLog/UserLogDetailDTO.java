...
public record UserLogDetailDTO (Long id_log, Users user, String altered_table, String id_altered, String field, String description, Instant datetime, EnumAction action) {
